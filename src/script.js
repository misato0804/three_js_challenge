...
const generateGraxy = () => {
  ...
  geometory.setAttribute("position", new THREE.BufferAttribute(positions, 3));
  geometory.setAttribute("color", new THREE.BufferAttribute(colors, 3));
